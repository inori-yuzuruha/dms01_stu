...
public class RegistFrame extends JFrame {
	...
	public RegistFrame() {
		...
		DefaultComboBoxModel<String> comboModel = new DefaultComboBoxModel<String>(str);
		cmbDegree = new JComboBox<String>(comboModel);
		// 设置组合框可编辑
	...
	private class RegisterListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (password.equals(rePassword)) {
				// 将数据封装到对象中
				user = new User( id,userName, password, sex, hobby, address, degree);
				// 保存数据
